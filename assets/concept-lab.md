...
<p align="center"><img src="testing/before-after.svg" alt="A plain README gains an animated hero at the top" width="90%"></p>
...
<p align="center"><img src="testing/generic-authentic.svg" alt="A generic AI-art blob wipes away to reveal an authentic hero" width="90%"></p>
...
<p align="center"><img src="testing/spotlight-scan.svg" alt="A spotlight scans across a dim hero, revealing it" width="90%"></p>
...
<p align="center"><img src="testing/boot-up.svg" alt="A hero-readme banner assembling itself piece by piece" width="90%"></p>
...
<p align="center"><img src="testing/terminal-cast.svg" alt="A terminal runs the hero-readme command and the hero appears as output" width="90%"></p>

**6. Typewriter** — the wordmark types itself in, character by character, with a
blinking caret, then the tagline settles in.

<p align="center"><img src="testing/typewriter.svg" alt="The hero-readme wordmark types itself in with a blinking caret" width="90%"></p>
...
<p align="center"><img src="testing/theme-flip.svg" alt="One hero recoloring through several themes" width="90%"></p>
...
<p align="center"><img src="testing/side-by-side.svg" alt="A plain badge-only README beside one with an animated hero" width="90%"></p>
...
- Per-repo, each is recolored to the project's brand and re-themed to its concept —
  ...
  uniquely to every repo in the [wild gallery](wild/wild.md).
